...
Current performance test durations:
...
| 1 Hour Sustained Load | 3,600,000 ms | Too long for PRs |

## Goals / Non-Goals

**Goals:**
- Reduce test durations to enable quick development cycles
- Maintain test coverage by keeping meaningful tests
...
| @extended | 1+ hours | Release benchmarks, scheduled runs |

### 2. Duration Reductions

**1 Hour Memory Stability**:
- @quick: 5 minutes (300,000 ms) - 120x faster
- @full: 30 minutes (1,800,000 ms) - 2x faster
- @extended: 1 hour (3,600,000 ms) - original

**8 Hour Memory Stability**:
- @quick: 10 minutes (600,000 ms) - 48x faster
- @full: 1 hour (3,600,000 ms) - 8x faster
- @extended: 8 hours (28,800,000 ms) - original

**1 Hour Sustained Load**:
- @quick: 5 minutes - 12x faster
- @full: 30 minutes - 2x faster
